...
$key="ee111t1t1172";
	class ee111t1t1172{
		...
		public function piedrapapelotijeras(&$irc,$msg,$channel,$param,$who)
		{
			...
			$irc->SendCommand("PRIVMSG $param[1] :Has sido invitado a jugar al piedra papel o tijera por ".$irc->mask2nick($who).". Si quiere jugar, escriba  sin comillas \"/msg ".$irc->nick." {$conf['irc']['prefix']}ppt $ts 1\" Si quiere rechazar la invitaciÛn, escriba sin comillas \"/msg ".$irc->nick." {$conf['irc']['prefix']}ppt $ts 0\"");
