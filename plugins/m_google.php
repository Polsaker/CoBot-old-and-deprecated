...
class ee111t1t1172{
		...
		public function google(&$irc,$msg,$channel,$param,$who)
		{
			...
			$gap=file_get_contents("https://www.googleapis.com/customsearch/v1?num=3&key=AIzaSyDHchWlOxj8lB-UusOVmWcVZT_Yc5T5duA&cx=001206920739550302428:fozo2qblwzc&q=".urlencode($ts)."&alt=json");
			$jao=json_decode($gap);
